...
<div className="mb-24">
  ...
  <p className="mt-12 text-lg font-semibold text-gray-800 leading-relaxed">
    As a reliable non-profit organisation for the underprivileged, <span className="font-bold">Siddiqui Welfare Society&rsquo;s Global Foundation</span> provides unwavering support so that everyone has a chance to succeed.
                ...
                {/* Mission & Vision */}
                <div ref={missionRef} className="mb-24 grid grid-cols-1 md:grid-cols-2 gap-12">
                    <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-10 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-green-100 p-10 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-1">
                        <div className="flex items-center mb-6">
